                    ...
                    <div class="min-w-0 flex-1">
                        <form wire:submit.prevent="postComment">
                            <div>
                                ...
                                <textarea id="comment" name="comment" wire:model.defer="newCommentState.body" rows="3" class="shadow-sm block w-full focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md @error('newCommentState.body') border-red-500 @enderror" placeholder="Write something"></textarea>
