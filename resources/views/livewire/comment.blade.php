    ...
    <div class="flex">
      ...
      <div class="flex-grow">
        ...
        <div class="mt-1 flex-grow w-full">
          @if ($isEditing)
          <form wire:submit.prevent="editComment" class="my-4">
            <div>
              <label for="comment" class="sr-only">Comment body</label>
              <textarea id="comment" name="comment" wire:model.defer="editState.body" rows="3" class="shadow-sm block w-full focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md @error('editState.body') border-red-500 @enderror" placeholder="Write something"></textarea>
      ...
      @if ($isReplying)
        <form wire:submit.prevent="postReply" class="my-4">
          <div>
            ...
            <textarea id="comment" name="comment" wire:model.defer="replyState.body" rows="3" class="shadow-sm block w-full focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md @error('replyState.body') border-red-500 @enderror" placeholder="Write something"></textarea>
